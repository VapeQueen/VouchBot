...
method('createWebhook', createWebhook, 'name, avatar', "Creates and returns the created Webhook.")
method('getWebhooks', getWebhooks, nil, "Iterator for the channel's Webhook(s) (not cached).")
